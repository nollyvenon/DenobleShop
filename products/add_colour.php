...
//print_r($allmain_supplier);
if ($_POST['add_colour']){
	$colour = $_POST['colour'];
	$colour_code = color_name_to_hex($colour);
	if ($colour != ""){
		$colour_name = $zentabooks_operation->add_colour($colour,$colour_code);
        if($colour) {
            $message_success = "You have successfully added the colour";
        } else {
            ...
            <div id="content">
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <ul class="breadcrumb">
                            <li><a href="<?php echo SITE_URL;?>/">Home</a></li><li><a href="<?php echo SITE_URL;?>/colour_index">Colour</a></li>
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-edit"></i>Add Colour</h2>
    </div>
                    ...
                    <div  class="col-md-12">
                        <div class="well well-sm">
                            <div class="form-group">
                                <label for="colour">Colour</label>                                <input type="text" name="colour" value=""  class="form-control tip" id="colour" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div
                                class="from-group"><input type="submit" name="add_colour" value="Submit"  id="add_colour" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;" />
