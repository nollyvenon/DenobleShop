...
if ($_POST['change_price']){
	...
	if ($product_price != ""){
		$product_price = $zentabooks_operation->edit_product_price($product_code,$product_price);
        if($product_price) {
            $message_success = "You have successfully edited the Product Price";
        } else {
...
<head>
    ...
    <title>Add Colour - ZentaBooks</title>
            ...
            <div id="content">
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <ul class="breadcrumb">
                            <li><a href="<?php echo SITE_URL;?>/">Home</a></li><li><a href="<?php echo SITE_URL;?>/colour_index">Product Price</a></li>
                            <li class="active">Set Product Price For <?=$name;?></li>                            
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-edit"></i>Set Product Selling Price For <?=$name;?></h2>
    </div>
                    ...
                    <div  class="col-md-5">
                        <div class="well well-sm">
                            <div class="form-group">
                                ...
                                <input type="text" name="product_price" value=""  class="form-control input-tip datetime" id="product_price" required="required" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div
                                class="from-group"><input type="submit" name="change_price" value="Submit"  id="change_price" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;" />
