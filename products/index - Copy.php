...
if(isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
	...
	$query = "SELECT us.*, b.name as brand_name, c.name as category_name
		...
		$supplier_name = get_company_user_details($id)['name'];
	$query = "SELECT us.*, b.name as brand_name, c.name as category_name
                FROM sma_products AS us
                LEFT JOIN sma_brands AS b ON us.brand = b.id
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <!--<td><?php echo $row['code']; ?></td>-->
                                ...
                                <td><a href="#" class="po" title="<b>Delete</b>"
                                           data-content='<div style="width:150px;"><p>Are you Sure</p><a class="btn btn-warning" id="<?=$row['employee_id'];?>" href="<?php echo SITE_URL;?>/hrmanager/delete_emp?hissdel=<?=$row['employee_id'];?>">I am Sure</a> <button class="btn po-close">No</button></div>'
                                           data-html="true"  rel="popover"><i class="btn btn-warning btn-xs">Delete</i></a>
                                
                                <div class="dropdown">
  <button class="btn btn-primary btn-xs dropdown-toggle" type="button" data-toggle="dropdown">Actions
  <span class="caret"></span></button>
  <ul class="dropdown-menu">
    <li><a href="products/view/<?php echo $row['code']; ?>"><i class="fa fa-file-text-o"></i> Product Details</a></li>
    <li><?php echo "<a href='#' class='tip po' title='<b>Delete Product</b>' data-content=\"<p>
            Are YOU Sure</p><a class='btn btn-danger po-delete1' id='a__$1' href='SITE_URL/products/delete/$1') . '>
             Are YOU Sure</a> <button class=btn po-close'>No</button>\" data-html='true'  rel='popover'><i class=\"fa fa-trash-o\"></i> 
            Delete Product</a>";?></li>
    <li><a href="products/print_barcodes/<?php echo $row['code']; ?>"><i class="fa fa-print"></i> Print Barcode</a></li>
    <li><a href="products/add/<?php echo $row['code']; ?>"><i class="fa fa-plus-square"></i> Duplicate Product</a></li>
    ...
    <li><a href="products/edit/<?php echo $row['code']; ?>"><i class="fa fa-edit"></i> Edit Product</a></li>
  </ul>
</div></td>
                            </tr>
                        ...
                        <tr class="active">
                            ...
                            <th style="width:65px; text-align:center;">Actions</th>
								...
								<?php if(isset($list_products) && !empty($list_products)) { ?>
            	...
            	<?php if(isset($list_products) && !empty($list_products)) { require_once '../layouts/pagination_links.php'; } ?>
        </div>
    </div>
</div>
