...
if(isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
	...
	$query = "SELECT us.*, b.name as brand_name, c.name as category_name,cls.name as colour_name,cls.code as colour_code
				...
				WHERE (us.supplier1='$supplier' OR us.supplier2='$supplier' OR us.supplier3='$supplier' OR us.supplier4='$supplier' OR us.supplier5='$supplier' ORDER BY us.id DESC ";
...
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo SITE_URL;?>/products/addproduct">
                                <i class="fa fa-plus-circle"></i> Add Product                            </a>
                        </li>
                                                <li>
                            <a href="<?php echo SITE_URL;?>/products/update_price" data-toggle="modal" data-target="#myModal">
  ...
  <ul class="dropdown-menu">
    <li><a href="products/view_prod_details?hiss=<?=encrypt($row['code']);?>"><i class="fa fa-file-text-o"></i> Product Details</a></li>
    <li><a href="#" class="po" title="<b>Delete</b>"
            ...
            Delete Product</a></li>
    <?php if (contains( '6',$allowed_pages)) { ?><li><a href="<?php echo SITE_URL;?>/products/edit_price?hiss=<?=encrypt($row['code']); ?>"><i class="fa fa-print"></i> Edit Price</a></li><?php } ?>
    <?php if (contains( '135',$allowed_pages)) { ?><li><a href="<?php echo SITE_URL;?>/products/expiry_date?hiss=<?=encrypt($row['code']); ?>"><i class="fa fa-print"></i> Set Expiry Date</a></li><?php } ?>
    <?php if (contains( '136',$allowed_pages)) { ?><li><a href="<?php echo SITE_URL;?>/products/set_product_qty_alert?hiss=<?=encrypt($row['code']); ?>"><i class="fa fa-print"></i> Set Qty Alert</a></li><?php } ?>
    <?php if (contains( '8',$allowed_pages)) { ?><li><a href="<?php echo SITE_URL;?>/products/print_barcodes?hiss=<?=encrypt($row['code']); ?>"><i class="fa fa-print"></i> Print Barcode</a></li>
    <li><a href="<?php echo SITE_URL;?>/products/add?hiss=<?=encrypt($row['code']); ?>"><i class="fa fa-plus-square"></i> Duplicate Product</a></li>
    <li><a href="<?php echo SITE_URL.'/uploads/products/images/'.$row['image']; ?>" data-type="image" data-toggle="lightbox"><i class="fa fa-file-photo-o"></i> View Image</a></li>
    <?php if (contains( '3',$allowed_pages)) { ?><li><a href="<?php echo SITE_URL;?>/products/edit_product?hiss=<?=encrypt($row['code']); ?>"><i class="fa fa-edit"></i> Edit Product</a></li><?php } ?>
  </ul>
</div></td>
                            </tr>
