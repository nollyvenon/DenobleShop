...
if ($_POST['set_alert']){
	...
	$warehouse_qty = $_POST['warehouse_qty'];
	$store_qty = $_POST['store_qty'];
	if ($expiry_date != ""){
		$expiry_date = $zentabooks_operation->edit_set_alert($product_code,$warehouse_qty, $store_qty);
        if($expiry_date) {
            $message_success = "You have successfully edited the Alert Quantity ";
        } else {
...
<head>
    ...
    <title>Set Alert Quantity - ZentaBooks</title>
            ...
            <div id="content">
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <ul class="breadcrumb">
                            <li><a href="<?php echo SITE_URL;?>/">Home</a></li><li><a href="<?php echo SITE_URL;?>/colour_index">Alert Quantity</a></li>
                            <li class="active">Set Alert Quantity For <?=$name;?></li>                            
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-edit"></i>Set Alert Quantity For <?=$name;?></h2>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div  class="col-md-5">
                        <div class="well well-sm">
                            <div class="form-group">
                                <label for="colour">Warehouse Qty</label>                                
                                <input type="text" name="warehouse_qty" value=""  class="form-control input-tip" id="warehouse_qty" required="required" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div  class="col-md-5">
                        <div class="well well-sm">
                            <div class="form-group">
                                <label for="colour">Store Qty</label>                                
                                <input type="text" name="store_qty" value=""  class="form-control input-tip" id="store_qty" required="required" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div
                                class="from-group"><input type="submit" name="set_alert" value="Submit"  id="set_alert" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;" />
