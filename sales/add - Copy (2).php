	...
	function callAutoAsignValue1(idname,)
	{
			 ...
			 else
			 {
			  ...
			  total1="0000000";
				 ...
				 $.post("<?php echo SITE_URL;?>/sales/compute_subtotal.php", {netunitprice: $("#"+idname).val(), qty:89 },			
				 	function(data){
                ...
                <div class="row">
                 ...
                 <div class="table-responsive">  
                  ...
                  <table align="left" border="0" cellspacing="2" cellpadding="2"  id="duplicate">
					  ...
					  <td width="86"><input name="quantity[]" id="0000" required class=" col-md-12 form-control" type="text" size="35"  onfocus="callAutoAsignValue1(this.id)" onchange="callAutoAsignValue1(this.id)"/> </td>
