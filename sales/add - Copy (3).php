...
*/
	...
	function callAutoAsignValue1(idname)
	{
			
			 var quantity1 = parseInt(idname,10);	
			 var rate = parseInt(secname,10);	
			 //var rate1 =  quantity1-1;
			 var total1 = quantity1+3;
			
			 if(parseInt(idname)>0)
			 {
			 quantity1="00"+quantity1;
			 rate1="000"+rate1;
			 total1="0000000"+total1;
			...
			var rte = parseFloat( $("#netunitprice").val());
				 $.post("<?php echo SITE_URL;?>/sales/compute_subtotal.php", {netunitprice: $("#"+idname).val(), qty: 10},			
				 	function(data){
								
								$("#"+total1).val(data.sub_total);
							}, 'json');
							//alert("Data Loaded: " + data);
						checkDuplicateName();	
                ...
                <div class="row">
                 ...
                 <div class="table-responsive">  
                  ...
                  <table align="left" border="0" cellspacing="2" cellpadding="2"  id="duplicate">
                      ...
                      <td width="128"><input name="netunitprice[]" id="000"  required class=" col-md-12 form-control" type="text" size="35" /></td>
					  <td width="86"><input name="quantity[]" id="0000" required class=" col-md-12 form-control" type="text" size="35"  onfocus="callAutoAsignValue1(this.id,netunitprice.id)" onchange="callAutoAsignValue1(this.id,netunitprice.id)"/> </td>
                      <td width="128"><input name="discount[]" id="00000"  required class=" col-md-12 form-control" type="text" size="35" /></td>
                      <td width="86"><input name="producttax[]" id="000000"  required class=" col-md-12 form-control" type="text" size="35" />  </td>
                      <td width="128"><div id="txtHint1"><input name="subtotal[]" id="0000000"  required class=" col-md-12 form-control" type="text" size="35" /></div> </td>
