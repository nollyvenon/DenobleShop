                ...
                <div class="row">
                 ...
                 <div class="table-responsive">  
                  ...
                  <table align="left" border="0" cellspacing="2" cellpadding="2"  id="duplicate">
					  ...
					  <td width="86"><input name="quantity[]" id="0000" required class=" col-md-12 form-control" type="text" size="35"  onfocus="doCalc()" onchange="doCalc()"/> </td>
                      ...
                      <td width="128"><span class="amount"></span>  </td>
                ...
                <div id="bottom-total" class="well well-sm" style="margin-bottom: 0;">
                    <table class="table table-bordered table-condensed totals" style="margin-bottom:0;">
                        <tr class="warning">
                            ...
                            <td>Grand Total <div class="total_amount" id="gtotal">0.00</div></td>
                        </tr>
                    </table>
                </div>
