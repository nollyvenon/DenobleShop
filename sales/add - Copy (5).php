...
function check_dd1() {
    ...
    $('tr').each(function() {
       // $(this).find('span.amount').html($('input:eq(1)', this).val() * $('input:eq(2)', this).val() - $('input:eq(3)', this).val());
        var subtotal = $('input:eq(1)', this).val() * $('input:eq(2)', this).val() - $('input:eq(3)', this).val();
                ...
                <div class="row">
                    <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="date" value="<?= date('d/m/Y H:i:s', time());?>"  class="form-control input-tip datetime" id="sldate" required="required" />
                                </div>
                            </div>
                 ...
                 <div class="table-responsive">  
                   ...
                   <thead> <tr class="title">
                      <th width="278">Product (Code - Name)<span class="required">*</span></th>
                      <th width="87">Serial No</th>
                      <th width="128"> Price</th>
                      <th width="86">Quantity</th>
                      <th width="128">Discount</th>
                      <th width="86">Product Tax</th>
                      <th width="128">Subtotal (NGN)</th>
                  ...
                  <table align="left" border="0" cellspacing="2" cellpadding="2"  id="duplicate">
  						<tr>
  						  <td width="28%"><select name="product[]" id="0"  onBlur="callAutoAsignValue(this.id)" onChange="callAutoAsignValue(this.id)"  class=" col-md-12 form-control" data-live-search="true" >
                      ...
                      <td width="87"><input name="serialnumber[]" id="00"   class=" col-md-12 form-control" type="text" size="35" /></td>
                      <td width="123"><input name="netunitprice[]" type="text"  required class=" col-md-12 form-control" id="000" size="35" readonly /></td>
					  <td width="80"><input name="quantity[]" id="0000" required class=" col-md-12 form-control" type="text" size="35"  onfocus="doCalc()" onchange="doCalc()"/> </td>
                      <td width="125"><input name="discount[]" id="00000"   class=" col-md-12 form-control" type="text" size="35" onfocus="doCalc()" onchange="doCalc()"/></td>
                      <td width="86"><input name="producttax[]" id="000000"   class=" col-md-12 form-control" type="text" size="35" />  </td>
                      <td width="128" style="text-align:center"><span class="amount">₦0.00</span> <div class="amount2" style="display:none"></div> <!--<input name="amount1[]" id="amount1" value="0" type="textfield">--> </td>
                      <td width="45"><a id="minus" href=""  ><i class="fa fa-trash-o" style="opacity:0.5; filter:alpha(opacity=50);"></i></a> <a id="plus" href="">[+]</a></td>
                    </tr>
					  <tr>
					    <td>&nbsp;</td>
						<td>&nbsp;</td>
