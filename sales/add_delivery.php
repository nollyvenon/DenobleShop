...
$sales_details = $zentabooks_operation->view_sales_detail($hiss);
extract($sales_details);
$cust_details = $zentabooks_operation->get_company_user_details($customer_id);
$trans_count = $zentabooks_operation->get_no_of_monthly_transactions('sma_deliveries',date('m'))+1;
$refno = "DO/".date('Y').'/'.date('m').'/'.sprintf("%04s", $trans_count);
if ($_POST['add_delivery']){
	$date = $_POST['date'];
	...
	$delivery_details = $zentabooks_operation->add_delivery($date, $do_reference_no, $sale_reference_no, $customer, $address, $status, $delivered_by, $received_by, $document, $note);
...
<div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Add Sales Delivery</h4>
        </div>
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-6">
                        ...
                        <label for="do_reference_no">Delivery Reference No</label>                        
                        <input name="do_reference_no" value="<?= $refno;?>" class="form-control tip" id="do_reference_no" type="text">
                    </div>
...
<option value="delivered">Delivered</option>
                    ...
                    <div class="form-group">
                        <label for="delivered_by">Delivered by</label>                        <input name="delivered_by" value="" class="form-control" id="delivered_by" type="text">
                    </div>

                    <div class="form-group">
                        <label for="received_by">Received by</label>                        <input name="received_by" value="" class="form-control" id="received_by" type="text">
                    </div>
   ...
   <div class="input-group-btn">
       ...
       <div class="btn btn-primary btn-file"> <i class="fa fa-folder-open"></i> &nbsp;Browse ... <input id="attachment" data-browse-label="Browse ..." name="document" data-show-upload="false" data-show-preview="false" class="form-control file" type="file"></div>
        ...
        <div class="modal-footer">
            <input name="add_delivery" value="Add Delivery" class="btn btn-primary" type="submit">
        </div>
    </form></div>
