...
echo $hiss = preg_replace("/[^A-Za-z0-9 ]/", '', $id_encrypted);
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-file"></i>Sales Number. <?= $hiss;?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                                                <li>
                            <a href="<?php echo SITE_URL;?>/sales/payments?hissdel=<?=encrypt($id);?>" data-target="#myModal" data-toggle="modal">
                                <i class="fa fa-money"></i> View Payments                            </a>
                        </li>
                        <li>
                            <a href="<?php echo SITE_URL;?>/sales/add_payment?hissdel=<?=encrypt($id);?>" data-target="#myModal" data-toggle="modal">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="well well-sm">
                    ...
                    <div class="col-xs-4 border-right">
                        ...
                        <div class="col-xs-10">
                           ...
                           <?= $zentabooks_operation->get_salespoint_by_id($salespoint_id)['name'];?>
                            <p><?= $zentabooks_operation->get_salespoint_by_id($salespoint_id)['address'];?></p><br>                        </div>
                        <div class="clearfix"></div>
                    </div>
                    ...
                    <div class="col-xs-4">
                        ...
                        <div class="col-xs-10">
                            ...
                            <?php $comp_details = $zentabooks_operation->get_company_user_details($customer_id);
                    ...
                    <div class="col-xs-4 border-left">
                        ...
                        <div class="col-xs-10">
                            ...
                            <p style="font-weight:bold;">Status: <?php echo ucfirst($sale_status);?></p>
                            <p style="font-weight:bold;">Payment Status: <?php echo ucfirst($payment_status);?></p>
                        </div>
                        <div class="clearfix"></div>
                ...
                <div class="row">
                    ...
                    <div class="btn-group">
                        <a href="<?php echo SITE_URL;?>/sales/payments?hissdel=<?=encrypt($row['id']);?>" class="tip btn btn-primary tip" title="View Payments">
                    ...
                    <?php  } ?>
                    <div class="btn-group">
                        <a href="<?php echo SITE_URL;?>/email?hissdel=<?=encrypt($row['id']);?>" data-toggle="modal" data-target="#myModal" class="tip btn btn-primary tip" title="Email">
                            <i class="fa fa-envelope-o"></i> <span class="hidden-sm hidden-xs">Email</span>
                        </a>
                    </div>
                    <div class="btn-group">
                        <a href="<?php echo SITE_URL;?>/sales/stocknotificationemail?hissdel=<?=encrypt($row['id']);?>" data-toggle="modal" data-target="#myModal" class="tip btn btn-primary tip" title="Email">
...
<script type="text/javascript" charset="UTF-8">var oTable = '', r_u_sure = "Are you sure?";
    ...
    $(window).load(function () {
        ...
        $('#purchases_view').addClass('active');
