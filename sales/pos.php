...
<head>
    <meta charset="utf-8">
    <title>POS Module | ZentaBooks</title>
    <script type="text/javascript">if(parent.frames.length !== 0){top.location = '<?php echo SITE_URL;?>/pos';}</script>
    ...
    <link rel="stylesheet" href="<?php echo SITE_ASSETS;?>/styles/theme.css" type="text/css"/>
    <link rel="stylesheet" href="<?php echo SITE_ASSETS;?>/styles/style.css" type="text/css"/>
    <link rel="stylesheet" href="<?php echo SITE_ASSETS;?>/pos/css/posajax.css" type="text/css"/>
    <link rel="stylesheet" href="<?php echo SITE_ASSETS;?>/pos/css/print.css" type="text/css" media="print"/>
...
<div id="wrapper">
    ...
    <div id="content">
        <div class="c1">
            <div class="pos">
                                                <div id="pos">
                    <form action="<?php echo SITE_URL;?>/pos" data-toggle="validator" role="form" id="pos-sale-form" method="post" accept-charset="utf-8">
                                                                                      <input type="hidden" name="token" value="67f65cc8fc8d613b74fc3875a0df4322" />
                    <div id="leftdiv">
                        <div id="printhead">
                            <h4 style="text-transform:uppercase;">ZentaBooks</h4>
                            <h5 style="text-transform:uppercase;">Order List</h5>Date 31/05/2017 23:35                        </div>
                        <div id="left-top">
                            <div
                                style="position: absolute; left:-9999px;"><input type="text" name="test" value=""  id="test" class="kb-pad" />
</div>
                            ...
                            <div class="no-print">
                                                                    <div class="form-group">
                                        <select name="warehouse" id="poswarehouse" class="form-control pos-input-tip" data-placeholder="Select Warehouse" required style="width:100%;" >
<option value=""></option>
                        ...
                        <div id="cpinner">
                            <div class="quick-menu">
                                <div id="proContainer">
                                    <div id="ajaxproducts">
                                        <div id="item-list">
                                            <div><button id="product-0101" type="button" value='BLACPORSCH' title="Blackberry Porsche" class="btn-prni btn-primary product pos-tip" data-container="body"><img src="<?php echo SITE_URL;?>/assets/uploads/thumbs/no_image.png" alt="Blackberry Porsche" style='width:60px;height:60px;' class='img-rounded' /><span>Blackberry Porsche</span></button><button id="product-0102" type="button" value='HUAWEI_MATE9' title="Huawei Mate 9" class="btn-prni btn-primary product pos-tip" data-container="body"><img src="<?php echo SITE_URL;?>/assets/uploads/thumbs/no_image.png" alt="Huawei Mate 9" style='width:60px;height:60px;' class='img-rounded' /><span>Huawei Mate 9</span></button><button id="product-0104" type="button" value='INFINZR4' title="Infinix Zero 4" class="btn-prni btn-primary product pos-tip" data-container="body"><img src="<?php echo SITE_URL;?>/assets/uploads/thumbs/no_image.png" alt="Infinix Zero 4" style='width:60px;height:60px;' class='img-rounded' /><span>Infinix Zero 4</span></button><button id="product-0108" type="button" value='8806088175980' title="Samsung Galaxy S7 Edge 64GB Gold" class="btn-prni btn-primary product pos-tip" data-container="body"><img src="<?php echo SITE_URL;?>/assets/uploads/thumbs/no_image.png" alt="Samsung Galaxy S7 Edge 64GB Gold" style='width:60px;height:60px;' class='img-rounded' /><span>Samsung Galaxy S7 Edge 64GB Gold</span></button><button id="product-0106" type="button" value='SAMSUNGS7' title="Samsung S7 Edge 32GB" class="btn-prni btn-primary product pos-tip" data-container="body"><img src="<?php echo SITE_URL;?>/assets/uploads/thumbs/no_image.png" alt="Samsung S7 Edge 32GB" style='width:60px;height:60px;' class='img-rounded' /><span>Samsung S7 Edge 32GB</span></button></div>                                        </div>
...
<div id="brands-slider">
    <div id="brands-list">
        <button id="brand-1" type="button" value='1' class="btn-prni brand" ><img src="assets/uploads/thumbs/no_image.png" style='width:60px;height:60px;' class='img-rounded img-thumbnail' /><span>Infinix</span></button><button id="brand-2" type="button" value='2' class="btn-prni brand" ><img src="assets/uploads/thumbs/no_image.png" style='width:60px;height:60px;' class='img-rounded img-thumbnail' /><span>Tecno</span></button><button id="brand-3" type="button" value='3' class="btn-prni brand" ><img src="assets/uploads/thumbs/no_image.png" style='width:60px;height:60px;' class='img-rounded img-thumbnail' /><span>LG Electronics</span></button><button id="brand-4" type="button" value='4' class="btn-prni brand" ><img src="assets/uploads/thumbs/no_image.png" style='width:60px;height:60px;' class='img-rounded img-thumbnail' /><span>Samsung</span></button>    </div>
</div>
<div id="category-slider">
    <!--<button type="button" class="close open-category"><i class="fa fa-2x">&times;</i></button>-->
    <div id="category-list">
        <button id="category-2" type="button" value='2' class="btn-prni category" ><img src="assets/uploads/thumbs/no_image.png" style='width:60px;height:60px;' class='img-rounded img-thumbnail' /><span>Electronics</span></button><button id="category-1" type="button" value='1' class="btn-prni category" ><img src="assets/uploads/thumbs/no_image.png" style='width:60px;height:60px;' class='img-rounded img-thumbnail' /><span>Phone</span></button><button id="category-3" type="button" value='3' class="btn-prni category" ><img src="assets/uploads/thumbs/no_image.png" style='width:60px;height:60px;' class='img-rounded img-thumbnail' /><span>Refrigerator</span></button>    </div>
</div>
            ...
            <div class="modal-body" id="payment_content">
                <div class="row">
                    <div class="col-md-10 col-sm-9">
                                                    <div class="form-group">
                                <label for="biller">Biller</label>                                <select name="biller" class="form-control" id="posbiller" required>
<option value="3" selected="selected">DeNoble Awka</option>
</select>
                            </div>
                                                <div class="form-group">
                            <div class="row">
                            ...
                            <div class="well well-sm well_1">
                                <div class="payment">
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <div class="form-group">
                                                <label for="amount_1">Amount</label>                                                <input name="amount[]" type="text" id="amount_1"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-11">
                                            <div class="form-group gc_1" style="display: none;">
                                                <label for="gift_card_no_1">Gift Card No</label>                                                <input name="paying_gift_card_no[]" type="text" id="gift_card_no_1"
                                            ...
                                            <div class="form-group">
                                                <label for="payment_note">Payment Note</label>                                                <textarea name="payment_note[]" id="payment_note_1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="gcexpiry">Expiry Date</label>                    <input type="text" name="gcexpiry" value="31/05/2019"  class="form-control date" id="gcexpiry" />
                </div>
...
<script type="text/javascript">
    var product_variant = 0, shipping = 0, p_page = 0, per_page = 0, tcp = "5", pro_limit = 20,
    ...
    var protect_delete = 0, billers = [{"logo":"logo41.png","company":"DeNoble Awka"}], biller = {"logo":"logo41.png","company":"DeNoble Awka"};
    var username = 'admin', order_data = '', bill_data = '';
    ...
    $(document).ready(function () {
                    ...
                    if(!el && sct.length > 0) {
                        ...
                        setTimeout(function() {
                            $.ajax({
                                type: "get",
                                async: false,
                                url: "<?php echo SITE_URL;?>/customers/suggestions/?term=" + sct,
                                dataType: "json",
        ...
        $(document).on('click', '.product', function (e) {
            ...
            $.ajax({
                type: "get",
                url: "<?php echo SITE_URL;?>/pos/getProductDataByCode",
        ...
        $(document).on('click', '.category', function () {
            if (cat_id != $(this).val()) {
                ...
                $.ajax({
                    type: "get",
                    url: "<?php echo SITE_URL;?>/pos/ajaxcategorydata",
        ...
        $(document).on('click', '.brand', function () {
            if (brand_id != $(this).val()) {
                ...
                $.ajax({
                    type: "get",
                    url: "<?php echo SITE_URL;?>/pos/ajaxbranddata",
        ...
        $(document).on('click', '.subcategory', function () {
            if (sub_cat_id != $(this).val()) {
                ...
                $.ajax({
                    type: "get",
                    url: "<?php echo SITE_URL;?>/pos/ajaxproducts",
    ...
    $(function () {
        ...
        mywindow.document.write('<link rel="stylesheet" href="<?php echo SITE_ASSETS;?>/styles/helpers/bootstrap.min.css" type="text/css" />');
...
<script type="text/javascript" src="<?php echo SITE_ASSETS;?>/pos/js/plugins.min.js"></script>
<script type="text/javascript" src="<?php echo SITE_ASSETS;?>/pos/js/parse-track-data.js"></script>
<script type="text/javascript" src="<?php echo SITE_ASSETS;?>/pos/js/pos.ajax.js"></script>
<script type="text/javascript">
