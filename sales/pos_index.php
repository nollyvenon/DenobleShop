...
if (!empty($_SESSION['salespoint_id']) || $salespoint_id==""){
...
if(isset($_POST['search_text']) && strlen($_POST['search_text']) > 3) {
	...
	$query = "SELECT us.*
				...
				LEFT JOIN sma_payments AS pay_m ON pay_m.sale_id = us.id "; 
	if ($salespoint_id != ""){
		$query .= "WHERE us.salespoint_id = '$salespoint_id' AND pay_m.paid_by='pos'";
	}else{
		$query .= "WHERE pay_m.paid_by='pos'";
	}
            ...
            <div id="content">
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <ul class="breadcrumb">
                            <li><a href="<?php echo SITE_URL;?>/">Home</a></li><li><a href="<?php echo SITE_URL;?>/sales/pos_index">POS Sales</a></li>                           <li class="right_log hidden-xs">
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i>POS Sales <?php if($hiss == ""){?> (All Salespoint) <?php }else{ echo '('.$mysalespoint.')';}?>       </h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?php echo SITE_URL;?>/sales"><i class="fa fa-building-o"></i> All Salespoint</a></li>
                            <li class="divider"></li>
                            <?php  foreach ($allsalespoints as $row) {   ?>
                ...
                <div class="table-responsive">
                    <table  id="hidden-table-info" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
							...
							$user_det = $zentabooks_operation->get_company_user_details($row['customer_id'])[0];
							?>
                            <tr>
  ...
  <ul class="dropdown-menu">
    <li><a href="<?php echo SITE_URL;?>/sales/view?hiss=<?php echo encrypt($row['id']); ?>" ><i class="fa fa-file-excel-o"></i>Sales Details </a> </li>
  <!--  <li><a href="sales/add/<?php echo $row['id']; ?>"><i class="fa fa-plus-square"></i> Duplicate Sale</a></li>-->
    <li><a href="sales/print_invoice?hiss=<?php echo encrypt($row['id']); ?>"><i class="fa fa-plus-square"></i> Print Invoice</a></li>
    <?php if (contains( '17',$allowed_pages)) { ?><li><a href="sales/payments?hiss=<?php echo encrypt($row['id']); ?>"><i class="fa fa-plus-square"></i> View Payments</a></li>
    <li><a href="sales/add_payment?hiss=<?php echo encrypt($row['id']); ?>"><i class="fa fa-plus-square"></i> Add Payments</a></li><?php } ?>
    <li><a href="sales/add_delivery?hiss=<?php echo encrypt($row['id']); ?>"><i class="fa fa-plus-square"></i> Add Delivery</a></li>
   <?php if (contains( '12',$allowed_pages)) { ?>
	<li><a href="sales/edit?hiss=<?php echo encrypt($row['id']); ?>"><i class="fa fa-plus-square"></i> Edit Sale</a></li><?php } ?>
    <?php if (contains( '15',$allowed_pages)) { ?><li><a href="sales/download?hiss=<?php echo encrypt($row['id']); ?>"><i class="fa fa-plus-square"></i> Download AS PDF</a></li><?php } ?>
   <?php if (contains( '14',$allowed_pages)) { ?>
    <li><a href="sales/email?hiss=<?php echo encrypt($row['id']); ?>"><i class="fa fa-plus-square"></i> EMail Sale</a></li><?php } ?>
    <?php if (contains( '18',$allowed_pages)) { ?><li><li><a href="sales/return_sale?hiss=<?php echo encrypt($row['id']); ?>"><i class="fa fa-plus-square"></i> Return Sale</a></li><?php } ?>
    
    
  <?php if (contains( '13',$allowed_pages)) { ?>
 <li><a href="#" class="po" title="<b>Delete</b>"
                                           data-content='<div style="width:150px;"><p>Are you sure?</p><a class="btn btn-danger" id="<?= $row['id'] ?>" href="sales/del_sales?hiss=<?php echo encrypt($row['id']); ?>">Yes I am Sure</a> <button class="btn po-close">No</button></div>'
