            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table  id="hidden-table-info1" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
							<?php 
							$payment_list = $zentabooks_operation->sales_commission_list($user_id);
                            ...
                            <tr>
                              ...
                              <td><a class="btn btn-warning btn-xs" href="<?php echo SITE_URL;?>/sales/view_sales_comm_det?hiss=<?php echo encrypt($row['id']); ?>&st=<?php echo encrypt($row['month']); ?>&sf=<?php echo encrypt($row['year']); ?>"><i class="fa fa-plus-square"></i> Details</a></td>
                            </tr>
