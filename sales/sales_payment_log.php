...
//$mysalespoint = $zentabooks_operation->get_salespoint_name_by_id($hiss);
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i>Sales Payment Log<?php if($salespoint_id == ""){?> (All Salespoints) <?php }else{ echo '('.$mysalespoint.')';}?>       </h2>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table  id="hidden-table-info1" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
							<?php 
							$payment_list = $zentabooks_operation->get_sales_payment_log($salespoint_id);
                            ...
                            <tr>
                              ...
                              <td><a class="btn btn-warning btn-xs" href="<?php echo SITE_URL;?>/sales/view?hiss=<?php echo encrypt($row['sale_id']); ?>"><i class="fa fa-plus-square"></i> Details</a></td>
                            </tr>
