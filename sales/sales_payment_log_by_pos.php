...
<head>
    ...
    <title>POS Sales Payment Log - ZentaBooks</title>
            ...
            <div id="content">
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <ul class="breadcrumb">
                            <li><a href="<?php echo SITE_URL;?>/">Home</a></li><li><a href="<?php echo SITE_URL;?>/sales">POS Sales Payment Log</a></li>                           <li class="right_log hidden-xs">
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i>POS Sales Payment Log<?php if($salespoint_id == ""){?> (All Salespoints) <?php }else{ echo '('.$mysalespoint.')';}?>       </h2>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table  id="hidden-table-info" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
							<?php 
							$payment_list = $zentabooks_operation->get_sales_payment_log($salespoint_id,'pos');
